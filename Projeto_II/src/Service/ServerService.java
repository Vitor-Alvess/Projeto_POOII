...
public class ServerService extends JFrame implements ActionListener {
    ...
    public ServerService (List<Candidate> list) {
...
class ClientHandler extends Thread {
    ...
    public ClientHandler(Socket socket, ServerService parent) {
